...
function App() {
  ...
  const getDefaultLevels = (): Level[] => [
    ...
    },
    {
      ...
      max_blocks: 20,
      hint: '蛇形路线：右走奇数位→上→左走偶数位→上→右走奇数位...',
      difficulty: '困难'
    },
    {
      id: 6,
      name: '回字迷宫',
      description: '8x8外圈回字，极难挑战！',
      grid_size: 8,
